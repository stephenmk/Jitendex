...
internal sealed class KanjiFormRestrictionTable : Table<KanjiFormRestrictionUpdate>
{
    ...
    protected override SqliteParameter[] Parameters(KanjiFormRestrictionUpdate update) =>
    [
