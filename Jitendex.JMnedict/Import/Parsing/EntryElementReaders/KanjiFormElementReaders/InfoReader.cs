...
namespace Jitendex.JMnedict.Import.Parsing.EntryElementReaders.KanjiFormElementReaders;

internal sealed class KInfoReader(ILogger<KInfoReader> logger) : BaseReader(logger)
{
