...
using Jitendex.Data.Export.Entities.GlossaryItems.SenseGroupItems.SenseItems;
...
public sealed class Sense
{
    ...
    public required int DisplayNumber { get; set; }
    ...
    public List<CrossReference> ReverseReferences { get; init; } = [];
}
