...
//
// This file, HeadwordRedirectTable.cs, is part of Jitendex.
//
...
internal sealed class HeadwordRedirectTable : Table<HeadwordRedirectRow>
{
    protected override string Name { get; } = nameof(HeadwordRedirect);
