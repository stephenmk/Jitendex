...
//
// This file, HeadwordSenseTable.cs, is part of Jitendex.
//
...
internal sealed class HeadwordSenseTable : Table<HeadwordSenseRow>
{
    protected override string Name { get; } = nameof(HeadwordSense);
