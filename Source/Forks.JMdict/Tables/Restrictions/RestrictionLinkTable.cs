...
//
// This file, RestrictionLinkTable.cs, is part of Jitendex.
//
...
{
    protected override string Name { get; } = nameof(RestrictionLink);
    ...
    protected override object?[] ParameterValues(RestrictionLinkRow row) =>
    [
        row.EntryId,
        row.ReadingOrder,
