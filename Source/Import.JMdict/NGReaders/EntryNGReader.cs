...
//
// This file, EntryNGReader.cs, is part of Jitendex.
//
...
internal partial class EntryNGReader
(
    ILogger<EntryNGReader> logger,
    ...
    protected override async Task ReadChildElementAsync(XmlReader xmlReader, Document document, EntryRow entry)
    {
        ...
        switch (xmlReader.Name)
        {
            ...
            case XmlTagName.LanguageSource:
                await languageSourceReader.ReadAsync(xmlReader, document, entry);
                break;
            case XmlNGTagName.EntryNote:
                await noteReader.ReadAsync(xmlReader, document, entry);
                break;
            default:
