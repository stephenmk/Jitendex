...
//
// This file, KanjiFormTable.cs, is part of Jitendex.
//
...
internal sealed class KanjiFormTable : Table<KanjiFormRow>
{
    ...
    protected override object?[] ParameterValues(KanjiFormRow row) =>
    [
        row.EntryId,
        row.Order,
        row.Text,
