...
//
// This file, DialectTable.cs, is part of Jitendex.
//
...
internal sealed class DialectTable : Table<DialectRow>
{
    ...
    protected override object?[] ParameterValues(DialectRow row) =>
    [
        row.EntryId,
        row.ParentOrder,
        row.Order,
