...
//
// This file, NameTypeTable.cs, is part of Jitendex.
//
...
internal sealed class NameTypeTable : Table<NameTypeRow>
{
    ...
    protected override object?[] ParameterValues(NameTypeRow row) =>
    [
        row.EntryId,
        row.ParentOrder,
        row.Order,
