...
//
// This file, RadicalTable.cs, is part of Jitendex.
//
...
{
    protected override string Name { get; } = nameof(Radical);
    ...
    protected override object?[] ParameterValues(RadicalElement radical) =>
    [
        radical.EntryId,
        radical.GroupOrder,
        radical.Order,
