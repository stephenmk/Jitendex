...
//
// This file, CodepointGroupTable.cs, is part of Jitendex.
//
...
{
    protected override string Name { get; } = nameof(CodepointGroup);
    ...
    protected override object?[] ParameterValues(CodepointGroupElement group) =>
    [
        group.EntryId,
        group.Order,
    ];
