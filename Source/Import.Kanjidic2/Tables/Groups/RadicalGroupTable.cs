...
//
// This file, RadicalGroupTable.cs, is part of Jitendex.
//
...
{
    protected override string Name { get; } = nameof(RadicalGroup);
    ...
    protected override object?[] ParameterValues(RadicalGroupElement group) =>
    [
        group.EntryId,
        group.Order,
    ];
