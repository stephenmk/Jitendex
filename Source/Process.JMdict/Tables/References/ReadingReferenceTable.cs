...
//
// This file, ReadingReferenceTable.cs, is part of Jitendex.
//
...
namespace Jitendex.Process.JMdict.Tables.References;
...
internal sealed class ReadingReferenceTable : Table<ReadingReferenceRow>
{
    ...
    protected override object?[] ParameterValues(ReadingReferenceRow row) =>
    [
        row.EntryId,
        row.SenseOrder,
